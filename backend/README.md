...
## Project Structure
    ...
    ├── ideapros_llc_fyxx_31943  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_fyxx_31943`
...
2. Clone this repo and `cd ideapros_llc_fyxx_31943`
